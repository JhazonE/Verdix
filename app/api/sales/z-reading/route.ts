  ...
  try {
    ...
    if (mode === 'current') {
        ...
        const generatedReading = {
            ...
            minSaleOrId: salesResult?.min_sale_or_id ? String(salesResult.min_sale_or_id) : 'OR-000000',
            maxSaleOrId: salesResult?.max_sale_or_id ? String(salesResult.max_sale_or_id) : 'OR-000000',
            ...
            minVoidOrId: voidSeqResult?.min_void_or_id ? String(voidSeqResult.min_void_or_id) : 'OR-000000',
            maxVoidOrId: voidSeqResult?.max_void_or_id ? String(voidSeqResult.max_void_or_id) : 'OR-000000',
            ...
            minReturnOrId: returnSeqResult?.min_return_or_id ? String(returnSeqResult.min_return_or_id) : 'OR-000000',
            maxReturnOrId: returnSeqResult?.max_return_or_id ? String(returnSeqResult.max_return_or_id) : 'OR-000000',
...
export async function POST(request: NextRequest) {
    try {
        ...
        const generatedReading = {
            ...
            minSaleOrId: salesResult?.min_sale_or_id || 'OR-000000', maxSaleOrId: salesResult?.max_sale_or_id || 'OR-000000',
            minVoidId: voidSeqResult?.min_void_id || '000000', maxVoidId: voidSeqResult?.max_void_id || '000000',
            minVoidOrId: voidSeqResult?.min_void_or_id || 'OR-000000', maxVoidOrId: voidSeqResult?.max_void_or_id || 'OR-000000',
            minReturnId: returnSeqResult?.min_return_id || '000000', maxReturnId: returnSeqResult?.max_return_id || '000000',
            minReturnOrId: returnSeqResult?.min_return_or_id || 'OR-000000', maxReturnOrId: returnSeqResult?.max_return_or_id || 'OR-000000',
